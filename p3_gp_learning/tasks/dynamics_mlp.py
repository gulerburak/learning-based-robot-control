...
from p3_gp_learning.data_utils import DATA_DIR, OUTPUT_DIR, generate_training_data
from p3_gp_learning.mlp_model import MLPRegressor
from p3_gp_learning.tasks.dynamics_gp import (
    GRID_SIZE,
    INPUT_COLUMNS,
    OUTPUT_COLUMNS,
    make_phase_grid,
...
def run_dataset(name: str, num_epochs: int, grid):
    ...
    model.plot_convergence(OUTPUT_DIR / f"3e_convergence_{name}.pdf")
    ...
    plot_phase_portrait(
        ...
        OUTPUT_DIR / f"3e_phase_portrait_{name}.pdf",
    )
