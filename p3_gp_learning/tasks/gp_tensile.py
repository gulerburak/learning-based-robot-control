...
from p3_gp_learning.gp_models import ExactGPModel, SVGPModel
...
def main():
    ...
    plot_fit(
        train_x, train_y, model, likelihood, "Exact GP", OUTPUT_DIR / "3a-1_exact_gp.pdf"
    )
