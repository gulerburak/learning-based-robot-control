...
from p2_control.common import SIM_DT, OUTPUT_DIR, make_time_steps
from p2_control.linearization import (
    cont2discrete_zoh,
...
def _plot_comparison(nominal_sim_ts, linearized_sim_ts):
    ...
    ax.legend()
    fig.tight_layout()
    fig.savefig(OUTPUT_DIR / "2d-1_linearization_rollout.pdf")
    plt.close(fig)
