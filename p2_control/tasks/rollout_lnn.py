...
from p2_control.lnn import discrete_forward_dynamics
from p2_control.tasks.train_lnn import PARAMS_NAME
...
def main():
    ...
    if args.animate:
        ...
        animate_robot(
            ...
            step_skip=5,
            show=False,
            filepath=str(OUTPUT_DIR / "2c-4_rollout_learned_dynamics.mp4"),
        )
