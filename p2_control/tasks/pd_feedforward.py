...
the feedback term the robot leaves the path, because a small error grows.
    ...
    python -m p2_control.tasks.pd_feedforward
"""
...
from p2_control.controllers import ctrl_fb_pd, ctrl_ff_feedforward
...
def main():
    ...
    save_tracking_plots(traj_ts, sim_ts, "2a-3_pd_feedforward")
