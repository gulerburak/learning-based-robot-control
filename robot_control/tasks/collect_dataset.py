...
The two limits control the quality of the dataset:
  ...
  * The torque must not be too large. If the torque is much larger than the gravity
    ...
    python -m robot_control.tasks.collect_dataset
    python -m robot_control.tasks.collect_dataset --num-simulations 5    # a quick check
"""
...
from robot_control.common import DATASET_DIR, SIM_DT, make_time_steps
