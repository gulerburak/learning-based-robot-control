...
from robot_control.lnn import dynamical_matrices as lnn_dynamical_matrices
from robot_control.tasks.rollout_lnn import load_nn_params
...
def main():
    ...
    save_tracking_plots(traj_ts, sim_ts, "pd_plus_learned")
